...
const GIST_URL = process.env.GIST_URL || 'https://gist.githubusercontent.com/YOUR_USERNAME/YOUR_GIST_ID/raw/gist-data.json';
...
export async function fetchGistData(): Promise<GistData> {
  ...
  try {
    console.log('🌐 Fetching gist data from:', GIST_URL);
    ...
    console.log('✅ Gist data fetched and cached');
    return data;
  } catch (error) {
...
export function invalidateCache(): void {
  cachedData = null;
  lastFetchTime = 0;
  console.log('🗑️ Gist cache invalidated');
}
